  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-red-600 hover:bg-red-700 text-white shadow-lg flex items-center justify-center transition-colors"
